...
// TypingNotif is sent by the client while composing a message.
// The server forwards it to the recipient(s); FromUser is filled by the server.
type TypingNotif struct {
